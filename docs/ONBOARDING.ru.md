...
5. **Прогони полный гейт сам.**
   ...
   Видишь `gate: ✓ зеленый - фазы A-D, каталог и doctor сошлись`. Это тот же гейт, что координатор гонит вне досягаемости атакующего агента: тесты, каталог, doctor и сквозной сценарий Деймоса A–D, и один код выхода.
...
7. **Посмотри шесть сканеров.**
   ...
   Видишь сиденье Ареса: провайдер `claude`, `daimons:[]` и шесть сканеров, где `deimos` оркестратор. Деймос гонит остальных цепочкой и сводит их коды выхода в один вердикт.
